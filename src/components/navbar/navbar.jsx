            ...
            <div>
                <div className="py-8 largel-navbar">
                    <div className="bg-bluegray-900 text-gray-100 p-3 flex justify-content-between lg:justify-content-center align-items-center flex-wrap padding-bottom" style={{marginTop: '-8.5rem', marginLeft: '-1rem', marginRight: '-1rem'}}>
                        ...
                        <span className="line-height-3">Get 15% off the first car you rent with us!.</span>
                        </div>
                ...
                <div className="bg-gray-900 py-3 px-6 shadow-2 flex align-items-center justify-content-between relative lg:static border-bottom-1 border-gray-800 largel-navbar" style={{ minHeight: '84px', marginTop: '-9.5rem', marginLeft: '-1rem', marginRight: '-1rem' }}>
                    ...
                    <div className={`align-items-center flex-grow-1 justify-content-between lg:flex absolute lg:static w-full bg-gray-900 left-0 top-100 z-1 shadow-2 lg:shadow-none border-1 lg:border-none border-gray-800 tabletqueri2 ${notHidden ? 'hidden' : "" }`}>
                        ...
                        <ul className="list-none p-0 m-0 flex lg:align-items-center select-none flex-column lg:flex-row" >
                            ...
                            <li>
                                <a href="/contact-us"className="p-ripple flex px-6 p-3 lg:px-3 lg:py-2 align-items-center text-gray-400 hover:text-white hover:bg-gray-800 font-medium border-round cursor-pointer transition-colors transition-duration-150 w-full no-underline">
                                    <Ripple/>
